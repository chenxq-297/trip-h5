...
import { TimeToMMDD } from '@/utils/processTimes'

import useHomeStore from '@/stores/modules/home';

const homeStore = useHomeStore()
const startDateStr = computed(() => TimeToMMDD(homeStore.DateInterval.startDate, "MM:DD"))
const endDateStr = computed(() => TimeToMMDD(homeStore.DateInterval.endDate, "MM:DD"))
// defineOptions({
//     inheritAttrs: false
// })
</script>
